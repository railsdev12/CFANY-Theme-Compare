...
<?php
	...
	<?php if ( ( Avada()->settings->get( 'logo', 'url' ) && '' !== Avada()->settings->get( 'logo', 'url' ) ) || ( Avada()->settings->get( 'logo_retina', 'url' ) && '' !== Avada()->settings->get( 'logo_retina', 'url' ) ) ) : ?>
		<a<?php echo $logo_anchor_tag_attributes; // WPCS: XSS ok. ?>>
			...
			<!-- standard logo -->
			<?php if (is_single( '51136' ))
        	{
	          $standard_logo['srcset'] = 'https://www.cfany.org/wp-content/uploads/2019/07/cfanyVector_whiteText1x.svg';
	          $standard_logo['url'] = $standard_logo['srcset'];
	          $retina_logo['srcset'] = 'https://www.cfany.org/wp-content/uploads/2019/07/cfanyVector_whiteText1x.svg';
