...
?>
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col tribe-date-block">
<div class="jms-date-block-inner">
	<time class="tribe-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>" aria-hidden="true">
		<span class="tribe-events-calendar-list__event-date-tag-month month">
			<?php echo esc_html( $event_day_month ); ?>
		</span>
		<span class="tribe-events-calendar-list__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium day-num">
			<?php echo esc_html( $event_day_num ); ?>
		</span>
				<span class="tribe-events-calendar-list__event-date-tag-weekday day-week">
