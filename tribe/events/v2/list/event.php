...
$container_classes = [ 'tribe-common-g-row', 'tribe-events-calendar-list__event-row custom-tribe-list-card' ];
...
?>
<div id="jms-listing" <?php tribe_classes( $container_classes ); ?>>

	<?php $this->template( 'list/event/date-tag', [ 'event' => $event ] ); ?>

	<div class="tribe-events-calendar-list__event-wrapper tribe-common-g-col tribe-event-info">
