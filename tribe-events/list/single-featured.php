...
<!-- Event Title -->
   ...
   <div class="tribe-date-block">
      ...
      <div class ="date-num"><?php echo tribe_get_start_date($event_id, false, 'j'); ?></div>
      <div class ="day-week"><?php echo tribe_get_start_date($event_id, false, 'D'); ?></div>
    </div>
...
<span id="js-featured-text policymakers">Global Policymakers Series</span>
 ...
 <?php if( $aos_event && ! $policy_event ): ?>
 <img class="aos-card-logo" src="/wp-content/uploads/2019/07/vectorAOS_white_vertical.svg">
 <?php endif; ?>
 
 <?php if( $policy_event ): ?>
 <img class="aos-card-logo policymakers" src="/wp-content/uploads/2020/05/PolicymakersVert_Whi.svg">
 <?php endif; ?>
