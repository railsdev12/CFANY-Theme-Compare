                ...
                <dl class="meta-details">
                    ...
                    <dd class="meta-grid">
						...
						<?php if( get_field('reg_settings') === 'None' ): ?>
                            <div class="register-attend"><a href="<?php echo $cvent_link; ?>" class="my-button-class fusion-button-wrapper fusion-aligncenter">Register to Attend</a></div>
                ...
                <dl class="meta-details">
                    ...
                    <dd class="meta-grid">
                        ...
                        <div class="live-register-link">
                            <a href="/global-policymakers-series/content-portal/" class="my-button-class fusion-button-wrapper fusion-aligncenter">Video Portal</a>
                        </div>
                    </dd>
                </dl>
            </div>
    ...
    <div class="main-mobile-metabox aos-only aos-virtual">
		...
		<?php else: ?>
            ...
            <div class="mobile-meta-livestream-box video-portal">
                ...
                <div class="mobile-register-attend nonmember">
                    <a href="/global-policymakers-series/content-portal/">Video Portal »</a>
                </div>
