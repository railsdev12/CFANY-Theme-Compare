...
?>
                ...
                <dl class="meta-details">
                    ...
                    <dd class="meta-grid">
						...
						<?php if( get_field('reg_settings') === 'None' ): ?>
                            <div class="register-attend"><a href="<?php echo $direct_reg_url; ?>" class="my-button-class fusion-button-wrapper fusion-aligncenter">Register to Attend</a></div>
						...
						<?php endif; ?>
                        <div class="meta-membership"><?php echo ' <a href="https://www.cfany.org/membership/">Not a Member Yet?</a> '?></div>
                    </dd>
                </dl>
            </div>
		<?php endif; ?>
                ...
                <dl class="meta-details">
                    ...
                    <dd class="meta-grid">
                        ...
                        <div class="live-register-link">
                            <a href="https://www.cfany.org/global-policymakers-series/content-portal/" class="my-button-class fusion-button-wrapper fusion-aligncenter">Video Portal</a>
                        </div>
                    </dd>
                </dl>
            </div>
    ...
    <div class="mobile-meta-section-title aos-only">
		...
		<?php if( tribe_event_is_all_day() || tribe_event_is_multiday() ): ?>
			...
			<?php esc_html_e( $start_date ) ?> <?php esc_html_e( ' and ', 'the-events-calendar' ) ?> <?php echo $end_date; // WPCS: XSS ok. ?> <p><?php esc_html_e( ' @ CFANY ', 'the-events-calendar' ) ?><span class="aos-mobile-cost"><?php echo the_field('to_attend_copy'); ?></span></p>

		<?php else : ?>

			<?php echo $the_customdate; ?> <span class = "mobile-time"> <?php echo $time_formatted; ?> </span>
            <p><?php esc_html_e( ' @ CFANY ', 'the-events-calendar' ) ?><span class="aos-mobile-cost"><?php echo the_field('to_attend_copy'); ?></span></p>
    ...
    <div class="main-mobile-metabox aos-only aos-virtual">
		...
		<?php else: ?>
            ...
            <div class="mobile-meta-livestream-box video-portal">
                ...
                <div class="mobile-meta-to-attend nonmembers"><?php esc_html_e( 'Society, FPA Members: ', 'the-events-calendar' ) ?></div>
                <div class="mobile-meta-cost"><?php esc_html_e( 'Access coming soon', 'the-events-calendar' ) ?></div>
                <div class="mobile-register-attend nonmember">
                    <a href="https://www.cfany.org/global-policymakers-series/content-portal/">Video Portal »</a>
                </div>
